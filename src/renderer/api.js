...
export const feeds = {
  ...
  fetchAll:       pick((force) => window.flux.feeds.fetchAll(force),  (force) => http('POST', '/api/feeds/fetch-all', { force: !!force })),
  fetchStream:    pick((force) => window.flux.feeds.fetchStream(force), (force) => http('POST', '/api/feeds/fetch-all', { force: !!force })),
